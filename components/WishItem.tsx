...
const WishItem = ({
  ...
  return (
    <tr className="hover:bg-gray-100 cursor-pointer">
      ...
      <td>
        <button className="btn btn-xs bg-[rgb(128,0,32)] text-white hover:text-[rgb(128,0,32)] border border-[rgb(128,0,32)] hover:bg-white hover:text-[rgb(128,0,32)] text-sm">
          <FaHeartCrack />
          <span
