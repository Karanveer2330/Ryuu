...
const AdminDashboardPage = () => {
  return (
    <div className="bg-[rgb(210,180,140)] flex justify-start max-w-screen-2xl mx-auto max-xl:flex-col">
      <DashboardSidebar />
      <div className="flex flex-col items-center ml-5 gap-y-4 w-full max-xl:ml-0 max-xl:px-2 max-xl:mt-5 max-md:gap-y-1">
        ...
        <div className="w-full bg-[rgb(128,0,32)] text-[rgb(210,180,140)] h-40 flex flex-col justify-center items-center gap-y-2">
